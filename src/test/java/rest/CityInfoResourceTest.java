...
import static rest.HobbyResourceTest.startServer;
...
public class CityInfoResourceTest {
    ...
    public void setUp() {
        ...
        c1 = new CityInfo("2300", "Copenhagen");
        c2 = new CityInfo("2450", "sydhavn");
        try {
    ...
    @Test
    public void testGetAllCityInfos() throws Exception{
        given()
                .contentType("application/json")
