...
@OpenAPIDefinition(info = @Info(title = "Demo on using JPA, Rest and OpenApi", version = "0.1", description = "This is the main ressource Person that has relationships to Clup and Address", contact = @Contact(name = "......", email = "...........")), tags = {
        @Tag(name = "person", description = "API related to person") }, servers = {
                @Server(description = "For Local host testing", url = "http://localhost:8080/exam_prep1/"),
...
public class PersonResource {
    ...
    public Response getSetup() {
        ...
        Person p1 = new Person("Hans", "Hansen", "hans@hansen.com", "11111111", "47");
        ...
        Person p2 = new Person("Jens", "Jensen", "jens@jensen.com", "22222222", "7");
        ...
        Person p3 = new Person("Simon", "Snow", "simon@snow.com", "33333333", "old as balls");
    ...
    @Operation(summary = "Get all person", tags = { "person" }, responses = {
